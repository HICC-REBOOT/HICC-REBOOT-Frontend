...
- 헤더
  ...
  - 수정사항
    - [x] 로그인 후, 어드민 인증 후 화면 표시
    - [x] 마이페이지 접속 시 프로필 아이콘 보여주기
    - [x] 새로고침 시 HICC 로고가 0.1초 뜬다.
    - [x] 메인에 헤더 색을 변하게 한다.
    - [x] 메인 헤더 fixed로 변경
...
- 탭
  ...
  - 수정사항
    - [x] 체크되어있지 않은 탭 스타일 넣기 하단 옅게
    - [x] 탭 사이즈 줄일 때 인디케이터 문제
...
- 컨펌
  ...
  - 확장 형태
    ...
    - [x] 내부 디자인 (라디오 버튼 제작)
    - [x] 확장에서 컨펌 띄울 때 확장 꺼지지 않도록 설정
  
  - [x] 호버 시 색 변동 이슈있음

  - 수정사항
    - [x] 바깥 영역 눌렀을 때 꺼지도록 변경
...
- 게시판
  ...
  - 수정사항
    - [x] 정렬 기준을 수정해야한다.
    - [x] 상세 그림 마진값 2rem만 주도록
    - [x] 글자수 ... 설정할게요...;;;
    - [x] update를 치고 들어갔을 때 문제 잡기
